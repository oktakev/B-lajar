...
<body style="background-image: url(Images/BG1.jpg);">
		...
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4" style="margin-top: 140px; ">
	...
	?>
					<form action="login/cek_login.php" method="post" role="form">
						<fieldset>
