...
<link rel="stylesheet" href="assets/css/content.css">
   ...
   <?php
							...
							$result = mysqli_query($con, "SELECT * FROM kelas INNER JOIN video ON kelas.id_kelas = video.id_kelas join user_guru on video.id_guru = user_guru.id_guru where video.id_video = '$_GET[id_video]' ORDER BY id_video DESC");
						?>
						<?php  
...
<section class="about_area p_120">
        	<div class="container">
        		<div class="main_title">
        			<h2><?php echo $user_data['judul_video']; ?></h2>
        		...
        		<div class="row about_inner">
        			...
        			<div class="col-lg-6">
						...
						<video width="560" source src="../guru/videos/<?php echo $user_data['src']; ?>" controls> </video>
        		...
        		<div class="comment-form">
									<h4>Leave a Reply</h4>
									<form id="form-comment" action="system/terusan_video.php" method="post">
        		...
        		<?php
							...
							include_once("../../config/koneksi.php");
 							// Fetch all users data from database
							$sql = mysqli_query($con, "SELECT * FROM komentar_video where id_video = '$_GET[id_video]' order by id_komentar_video asc");
						?>
