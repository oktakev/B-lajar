...
<section class="about_area p_120">
        	<div class="container">
        		...
        		<div class="row about_inner">
							...
							<div class="card">
								...
								<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
									...
									Kami disini juga telah menyediakan file berupa pdf sebagai pembelajaran secara lengkap dan detail mengenai setiap materi yang kita bagikan.kalian bisa mendownload file tersebut dan membacanya dimanapun dan kapanpun.<br>
										<a href="../guru/pdf/<?php echo $user_data['pdf'] ?>"><?php echo $user_data['pdf'] ?></a>
									</div>
								</div>
							</div>
							<div class="card">
        			...
        			<div class="col-lg-6">
        				<div class="video_area">
							<img class="img-fluid" src="../guru/images/<?php echo $user_data['gambar']; ?>" alt="">
        		...
        		<div class="comment-form">
									<h4>Leave a Reply</h4>
									<form id="form-comment" action="system/terusan_comments.php" method="post">
